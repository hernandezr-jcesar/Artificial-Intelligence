...
def print_search_tree(came_from):
    G = nx.DiGraph()
    labels = {}
...
def print_search_levels(graph, start, goal):
    visited = set()
    current_level = 0
...
print_search_levels(graph, start, final_pos)
draw_path(screen, pathIF, final_pos)  # Dibujar camino del agente 
print_search_tree(came_fromIF)